...
public class MarvelExternalService {
    ...
    @Value("${rest.key.public}")
    private String publicKey;
    @Value("${rest.key.private}")
    private String privateKey;
    @Value("${rest.marvel.baseurl}")
    ...
    private JsonNode findComicsCharactersById(Long heroId, Integer offset, Integer limit) {
        ...
        String url = UriComponentsBuilder.newInstance()
                ...
                .query("limit={limit}")
                .query("offset={offset}")
                .buildAndExpand(heroId, timestamp, publicKey, md5Hash, md5Hash, limit, offset)
                .toUriString();
